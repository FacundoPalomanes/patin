...
interface Updates {
  ...
  dni?: string;
  phoneNumber?: string;
  categoria?: string | FieldValue;
  photoURL?: string; 
}

export async function uploadUser(updates: Updates, uid: string) {
  try {
...
export async function updateUserPassword(email: string, newPassword: string, beforePassword: string) {
  try {
