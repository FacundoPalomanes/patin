...
export async function logInGetUserDB(uid: string) {
  try {
...
export async function addUserToDB(
  ...
  try {
    ...
    if (!userSnapshot.exists()) {
      if (responsibleName !== null && responsiblePhone !== null) {
...
export type FileWithBuffer = {
  buffer: Buffer;
  originalFilename?: string | null;  // Permitir `null` para compatibilidad
};


export async function addImageToDB(file: FileWithBuffer, user: User) {
  try {
