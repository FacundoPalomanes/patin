...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("Hubo un error trayendo los usuarios para administrador: ", error);
    return NextResponse.json({ message: "Hubo un error trayendo los usuarios para administrador" }, { status: 500 });
  }
}
